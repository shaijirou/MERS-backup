...
// Check if user is firefighter personnel
if (!isFirefighter()) {
...
$page_title = 'Firefighter Reports';
...
$conditions[] = "(ir.assigned_to = :user_id OR ir.responder_type = 'firefighter' OR ir.incident_type = 'Fire')";
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid px-4">
            ...
            <div class="d-flex justify-content-between align-items-center my-4">
                <div>
                    <h1 class="h3 mb-0">🔥 Firefighter Emergency Reports</h1>
                    <p class="text-muted">Comprehensive analysis of fire emergency response activities</p>
                </div>
            </div>
