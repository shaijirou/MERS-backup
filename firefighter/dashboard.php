                                                ...
                                                <tr class="<?php echo isFireRelated($incident['incident_type']) ? 'table-danger' : ''; ?>">
                                                    ...
                                                    <td>
                                                        <div class="btn-group btn-group-sm">
                                                            ...
                                                            <button class="btn btn-outline-danger" onclick="updateStatus(<?php echo $incident['id']; ?>, 'on_scene')" title="Fighting Fire">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Fire Incident Details</h5>
