...
// Fetch barangay personnel profile picture
$barangay_id = isset($_SESSION['user_id']) ? $_SESSION['user_id'] : null;
...
try {
    if ($barangay_id) {
        ...
        if ($barangay_data && !empty($barangay_data['id_document'])) {
            // Use absolute path for file_exists, but relative path for src attribute
            $profile_picture_filename = $barangay_data['id_document'];
...
<nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
    <div class="container-fluid">
        ...
        <h4 style="margin-left: 8px;"><?php echo isset($_SESSION['user_name']) ? htmlspecialchars($_SESSION['user_name']) : 'Barangay Personnel'; ?></h4>
