    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid px-4">
            ...
            <div class="d-flex justify-content-between align-items-center my-4">
                <div>
                    <h1 class="h3 mb-0">📊 Barangay Emergency Reports</h1>
                    <p class="text-muted">Comprehensive analysis of barangay emergency response activities</p>
                </div>
            </div>
