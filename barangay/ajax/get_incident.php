...
if (isset($_GET['id'])) {
    ...
    if ($incident) {
        ...
        <div class="row">
            <div class="col-md-6">
                <h6>Local Incident Information</h6>
                <p><strong>Report Number:</strong> <?php echo htmlspecialchars($incident['report_number']); ?></p>
                <p><strong>Incident Type:</strong> <?php echo htmlspecialchars($incident['incident_type']); ?></p>
                        ...
                        <div class="row">
                            <?php foreach ($photos as $photo): ?>
                                <div class="col-md-4 mb-2">
                                    <img src="../<?php echo htmlspecialchars($photo); ?>" class="img-fluid rounded" alt="Local Incident Photo">
                                </div>
                            <?php endforeach; ?>
                        </div>
                    <?php endif; ?>
        ...
        <div class="row mt-3">
            <div class="col-12">
                <div class="alert alert-success">
                    ...
                    <strong>Barangay Response:</strong> As the local emergency response unit, coordinate with other agencies if needed and ensure resident safety is prioritized.
                </div>
            </div>
        </div>
        <?php
        ...
        echo '<p class="text-center">Local incident not found.</p>';
    }
} else {
