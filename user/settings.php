            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="account">
                    <div class="card shadow-sm">
                        <div class="card-header bg-white">
                            <h5 class="card-title mb-0">
                                <i class="bi bi-person-gear-fill me-2"></i>Account Management
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <p><strong>Account ID:</strong> <?php echo $user['id']; ?></p>
                                    <p><strong>Member Since:</strong> <?php echo date('F j, Y', strtotime($user['created_at'])); ?></p>
                                    <p><strong>Last Updated:</strong> <?php echo $user['updated_at'] ? timeAgo($user['updated_at']) : 'Never'; ?></p>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="d-grid gap-2">
                                        ...
                                        <button type="button" class="btn btn-outline-secondary" onclick="downloadData()">
                                            <i class="bi bi-download me-1"></i>Download My Data
                                        </button>
                                        <button type="button" class="btn btn-outline-info" onclick="requestSupport()">
                            ...
                            <div class="alert alert-danger">
                                ...
                                <p class="mb-3">Once you deactivate your account, you will lose access to all features and your data will be archived.</p>
